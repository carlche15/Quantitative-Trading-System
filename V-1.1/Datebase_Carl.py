...
from yahoo_finance import YQLQueryError
...
default_ticker=["AAPL","GOOG","MSFT","XOM","BRK-A","AMZN","FB","JNJ","GE","T",
         ...
         "CVS","MA","AGN","UPS","NKE","QCOM","HON","WBA","YHOO"]
def trans(a):
                  ...
                  if(Share(ticker[i])!=None):
                              ...
                              try:
                                 ...
                                 df.to_sql(con=connection, name="stock_data", flavor="sqlite", if_exists="append")
                                  ...
                                  print "KeyError, Jump to next ticker...."
                                  continue
                              print i+1, "/"+str(len(ticker))+" are completed!"
                  else:
                            print "Empty ticker"
               except JSONDecodeError,YQLQueryError :
                         print ticker[i] + " has no respond, proceeding to next ticker!  :("
                         continue
